...
class KakaoAddressSearchServiceTest extends AbstractIntegrationContainerBaseTest {
    ...
    def "address 파라미터 값이 null 이면, requestAddressSearch 메소드는 null 을 리턴"() {
        given:
        String address = null
    ...
    def "주소값이 valid 하다면, requestAddressSearch 메소드는 정상적으로 document 를 반환"() {
        given:
    ...
    def "정상적인 주소를 입력했을 경우, 정상적으로 위도 경도로 변환 한다."() {
        given:
